...
config.nuve.superserviceID = '554c0235d4d9ced3c7da6ad5'; // default value: ''
config.nuve.superserviceKey = '8592'; // default value: ''
...
config.erizoController.publicIP = '71.188.81.247'; //default value: ''
...
// Use '' to automatically get IP from the interface
config.erizoAgent.publicIP = '71.188.81.247'; //default value: ''
...
config.erizo.stunserver = '77.72.174.167'; // default value: ''
...
config.erizoController.publicIP = '71.188.81.247';
config.erizo.minport = 30000;
config.erizo.maxport = 31000;
config.erizoAgent.publicIP = '71.188.81.247';