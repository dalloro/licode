cmd_Release/obj.target/addon/WebRtcConnection.o := g++ '-D_LARGEFILE_SOURCE' '-D_FILE_OFFSET_BITS=64' '-DBUILDING_NODE_EXTENSION' -I/root/.node-gyp/0.10.37/src -I/root/.node-gyp/0.10.37/deps/uv/include -I/root/.node-gyp/0.10.37/deps/v8/include -I/vagrant/./licode/scripts/../erizo/src/erizo -I/vagrant/./licode/scripts/../erizo/../build/libdeps/build/include  -Wall -Wextra -Wno-unused-parameter -pthread -m32 -D__STDC_CONSTANT_MACROS -O2 -fno-strict-aliasing -fno-tree-vrp -fno-omit-frame-pointer -fno-exceptions -Wall -O3 -g -std=c++0x -fexceptions -MMD -MF ./Release/.deps/Release/obj.target/addon/WebRtcConnection.o.d.raw  -c -o Release/obj.target/addon/WebRtcConnection.o ../WebRtcConnection.cc
Release/obj.target/addon/WebRtcConnection.o: ../WebRtcConnection.cc \
 ../WebRtcConnection.h /root/.node-gyp/0.10.37/src/node.h \
